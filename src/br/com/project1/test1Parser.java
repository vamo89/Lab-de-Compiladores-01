...
public class test1Parser extends Parser {
    ...
    // $ANTLR start "rule"
    // C:\\Documents and Settings\\teste\\workspace\\sample\\src\\br\\com\\project1\\test1.g:16:1: rule : (id= IDENT )+ ;
    public final void rule() throws RecognitionException {
        Token id=null;

        try {
            // C:\\Documents and Settings\\teste\\workspace\\sample\\src\\br\\com\\project1\\test1.g:16:5: ( (id= IDENT )+ )
            // C:\\Documents and Settings\\teste\\workspace\\sample\\src\\br\\com\\project1\\test1.g:17:3: (id= IDENT )+
            {
            // C:\\Documents and Settings\\teste\\workspace\\sample\\src\\br\\com\\project1\\test1.g:17:5: (id= IDENT )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
